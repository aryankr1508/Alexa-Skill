...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Welcome to News Headline.We tell you some news headlines everyday."
...
class NewsIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output =''
        # text_combined =''
        # reprompt = " Want to listen more?"
        api_address = 'https://newsapi.org/v2/top-headlines?country=in&apiKey=36e3e841173a464caa631563a8559b99'
        response = requests.get(api_address)
        response_json = response.json()
        formatted_response = [ i['title'] for i in response_json['articles']]
        # for i in response_json['articles']:
        #     text_combined = i['title'] + reprompt
...
class HelpIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output = "Hello, how i can help you? You can ask that tell me tipsy news headlines"
